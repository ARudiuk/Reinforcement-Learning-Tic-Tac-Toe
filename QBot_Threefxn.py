...
class QBot_Threefxn:
    def __init__(self,name,nhidden,board_size,mu = 0.7, gamma = 0.4, epsilon = 0.1,learning_rate=0.4):
        self.name = name
        self.board_size = board_size
        self.nhidden = nhidden
        self.learning_rate = learning_rate
        does_file_exist = path.isfile(name+'weights1'+'.npy')
        self.ann = tdann.ANN(self.board_size*2+1,3,self.nhidden,learning_rate=self.learning_rate)
        if does_file_exist:
